...
public class SQLiteDBDeploy
{
			...
			throws IOException
	{
		...
		HttpURLConnection c = (HttpURLConnection) new URL(dbUrl)
				.openConnection();
	 ...
	 *            the database
	 * @param dbStream
	 *            stream to read dump data
	 * @throws IOException
	 */
	private static void deploy(SQLiteDatabase sqlLiteDb, InputStream dbStream)
			throws IOException
	{
	 ...
	 * @throws SQLException
	 */
	private static void deploy(SQLiteDatabase sqlLiteDb,
			InputStreamReader dbReader) throws IOException
	{
		String sqlLine = null;
